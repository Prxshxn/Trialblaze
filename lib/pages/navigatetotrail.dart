...
class NavigatetoTrailPage extends StatefulWidget {
  final String trailId;
  const NavigatetoTrailPage({super.key, required this.trailId});

  @override
  State<NavigatetoTrailPage> createState() => _NavigatetoTrailPageState();
}

class _NavigatetoTrailPageState extends State<NavigatetoTrailPage> {
  @override
  void initState() {
    super.initState();
    _fetchAndNavigate();
